public class task2_algo 
{
    ...
    {
        int[] weights = {8, 7, 6, 5, 4};  // these are the weights of luggage of each experience IDs
...
for (int i = 1; i <= n; i++) //dp table begins to fill
{
for (int w = 0; w <= W; w++) 
{
if (weights[i-1] <= w)  //checks for weight units to be less than the max(20)
{
